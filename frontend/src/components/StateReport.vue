    ...
    <div class="px-4 my-10">
      <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
        <div class="flex flex-wrap border-b border-gray-200 undefined">
          <div class="bg-gradient-to-tr from-pink-500 to-pink-700 -mt-10 mb-4 rounded-xl text-white grid items-center w-24 h-24 py-4 px-4 justify-center shadow-lg mb-0">
            <TrendingUpIcon
              class="w-8 h-8 mr-2 text-violet-400e"
              aria-hidden="true"
            />
          </div>
        ...
        <div class="text-sm text-gray-700 pt-4 flex items-center undefined">
          <ArrowSmUpIcon
              ...
              aria-hidden="true"
            />
          <span class="text-green-500 ml-1 mr-2">
            3.48
          </span>
